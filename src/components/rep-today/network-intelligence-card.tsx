...
import { NETWORK_INSIGHTS, type NetworkInsight } from "@/lib/rep-today-data";
...
export function NetworkIntelligenceCard() {
  return (
    <SectionCard
      ...
      description="Example insights based on category intelligence"
    ...
    >
      {NETWORK_INSIGHTS.map((insight, i) => (
